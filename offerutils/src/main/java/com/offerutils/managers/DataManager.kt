...
class DataManager {
    ...
    enum class Type {
        ...
        USER_INVITE_CODE, ENTERED_CODE, GIFT_IS_READY, SLOTS_BONUS_ATTEMPTS, GIFT_CHARGE, FRIEND_INVITE, REMOVED_NOTIFICATION, MOTIVATION_TIME, HIDE_EXTRA_BUTTON, IS_FYBER_VIDEO, FYBER_CONSENT, IS_NAME_REWARDED, IS_EMAIL_REWARDED, CURRENT_BOOSTER, TIMER_BOOST,
        //analytics
        REWARD_COUNT,
